  ...
  return (
    <Canvas dpr={[1.5, 2]} camera={{ position: [-20, 40, 30], fov: 45, near: 1, far: 300 }}>
      ...
      <Physics gravity={[0, -60, 0]}>
        <Letter char="W" position={[1, 50, -1]} rotation={[0, 0, 0]}>
        ...
        <Letter char="S" position={[-1, 80, 3]} rotation={[10, 11, 12]}>
          <Basic scale={3} />
        </Letter>
      ...
      <ContactShadows smooth={false} scale={100} position={[0, -5.05, 0]} blur={0.81} opacity={0.75} />
